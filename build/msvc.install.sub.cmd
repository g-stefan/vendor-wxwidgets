...
if exist output\lib\vc_x64_lib\ copy /Y /B "output\lib\vc_x64_lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
if exist output\lib\vc_lib\ copy /Y /B "output\lib\vc_lib\*.lib" "%INSTALL_PATH_DEV%\lib\*"
